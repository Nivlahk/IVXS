...
const _KW_NODE     = new Set(['if','fork','loop','dot','con','take','say','text','give','fun','class','init','end','from','make','note','for','in','wait','del','ask','post','use','key','sheets','email','by','try','err']);
